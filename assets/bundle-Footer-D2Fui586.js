import { b as createAstro, c as createComponent, a as renderComponent, F as Fragment, r as renderTemplate, m as maybeRenderHead, d as addAttribute, u as unescapeHTML, f as renderScript, g as defineStyleVars, h as renderHead, i as renderSlot } from './bundle-astro/server-CiTTiyOT.js';
import 'piccolore';
/* empty css                                */
import 'clsx';
...
const deployment = {"repoUrl":"https://github.com/ob-simad-sim/try"};
...
async function getUI(lang) {
  try {
    const ui = await __variableDynamicImportRuntimeHelper((/* #__PURE__ */ Object.assign({"../data/ar/ui.json": () => import('./bundle-ui-CZqaCqn3.js'),"../data/en/ui.json": () => import('./bundle-ui-DtKvgI5Y.js'),"../data/tr/ui.json": () => import('./bundle-ui-MbWgABNx.js')})), `../data/${lang}/ui.json`, 4);
    return ui.default;
  } catch {
    const ui = await import('./bundle-ui-MbWgABNx.js');
    return ui.default;
  }
}
...
async function getCategories() {
  try {
    const cats = await import('./bundle-urlFormatter-CSCIBXTT.js').then(n => n.a);
    return cats.default || {};
  } catch {
...
async function getProducts() {
  try {
    const prods = await import('./bundle-products-B6EBFhID.js');
...
const $$SEOHead = createComponent(($$result, $$props, $$slots) => {
  ...
  const canonicalURL = new URL(Astro2.url.pathname.toLowerCase(), Astro2.site || baseUrl);
